f2 = open('C:\\Users\\simran pandey\\Desktop\\pure_consonant\\\output_56k.txt','r')# File containing the unicode representation of words in above file
f3 = open('C:\\Users\\simran pandey\\Desktop\\pure_consonant\\result1.txt','w')
f1 = open('C:\\Users\\simran pandey\\Desktop\\pure_consonant\\pureflat.txt','w')
f4 = open('C:\\Users\\simran pandey\\Desktop\\pure_consonant\\counterpure.txt','w')
freq=[]
dictionary=[]
counter=[]
pure=[]
