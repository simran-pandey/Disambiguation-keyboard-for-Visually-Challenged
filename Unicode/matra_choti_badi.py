#!/usr/bin/env python
# encoding: utf-8
f1 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\unicode\\corpus_15k.txt','r')# File containing the unicode representation of words in above file
...
for line in f1:
	...
	line = line.replace('\xe0\xa5\x87','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\x8b','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa4\x82','\xe0\xa4\xbe')
	
	line = line.replace('\xe0\xa5\x83','\xe0\xa5\x80')#group2
	line = line.replace('\xe0\xa5\x82','\xe0\xa5\x80')
	line = line.replace('\xe0\xa5\x88','\xe0\xa5\x80')
