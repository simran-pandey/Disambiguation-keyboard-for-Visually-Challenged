#!/usr/bin/env python
# encoding: utf-8
f1 = open('C:\\Users\\pande\\Desktop\\IDC\\unicode\\corpus_15k.txt','r')# File containing the unicode representation of words in above file
f2 = open('C:\\Users\\pande\\Desktop\\IDC\\unicode\\replaced.txt','w')
f3 = open('C:\\Users\\pande\\Desktop\\IDC\\unicode\\result.txt','w')
f5 = open('C:\\Users\\pande\\Desktop\\IDC\\unicode\\counter.txt','w')
f7 = open('C:\\Users\\pande\\Desktop\\IDC\\unicode\\flatfile.txt','w')
freq=[]
dictionary=[]
counter=[]
dict=[]
...
for line in f1:
	...
	line = line.replace('\xe0\xa5\x83','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\x84','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\x86','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\x89','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\x8a','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\xa4','\xe0\xa4\xbe')
	line = line.replace('\xe0\xa5\xb2','\xe0\xa4\xbe')
	
	pure.append(line)
for line in pure:
	f2.write(line)
f2.close()
f4 = open('C:\\Users\\pande\\Desktop\\IDC\\unicode\\replaced.txt','r')	
dictionary = []
freq= []
characters= []
counter= []
