f2 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\replace\\output.txt','r')# File containing the unicode representation of words in above file
f3 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\replace\\result1.txt','w')
f4 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\replace\\counterpure.txt','w')
freq=[]
dictionary=[]
counter=[]
pure=[]
