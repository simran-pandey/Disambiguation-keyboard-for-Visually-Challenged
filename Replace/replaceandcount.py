...
for line in characters:# for every word in stored in the  array named characters
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\x96') or (line[i+2] == '\x97')or(line[i+2] == '\x98') or (line[i+2] == '\x99')):# if the word is 'ख,ग, घ,ङ'  
			line[i+2]= '\x95'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and(( line[i+2] == '\x98') or (line[i+2] == '\x99')or(line[i+2] == '\x9a')):
		    line[i+2]= '\x95'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\x9b') or (line[i+2] == '\x9c')or(line[i+2] == '\x9d') or (line[i+2] == '\x9e')):
			line[i+2]= '\x9a'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and(( line[i+2] == '\x9b')):
		    line[i+2]= '\x9a'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xa0') or (line[i+2] == '\xa1')or(line[i+2] == '\xa2') or (line[i+2] == '\xa3')):
			line[i+2]= '\x9f'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and(( line[i+2] == '\x9c') or (line[i+2] == '\x9d')):
		    line[i+2]= '\x9f'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xa5') or (line[i+2] == '\xa6')or(line[i+2] == '\xa7') or (line[i+2] == '\xa8')or (line[i+2] == '\xa9')):
			line[i+2]= '\xa4'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xab') or (line[i+2] == '\xac')or(line[i+2] == '\xad') or (line[i+2] == '\xae')):
			line[i+2]= '\xaa'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and(( line[i+2] == '\x9e')):
			line[i+2]= '\xaa'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xb0') or (line[i+2] == '\xb2')or(line[i+2] == '\xb5') or (line[i+2] == '\xb6')or(line[i+2] == '\xb1') or (line[i+2] == '\xb4')):
			line[i+2]= '\xaf'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and(( line[i+2] == '\x9f')):
			line[i+2]= '\xaf'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xb8') or (line[i+2] == '\xb9')):
		    line[i+2]= '\xb7'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and((line[i+2] == '\x8d')or(line[i+2] == '\x80')or (line[i+2] == '\x81')or (line[i+2] == '\x82')or (line[i+2] == '\x87')or (line[i+2] == '\x88')or (line[i+2] == '\x8b')or (line[i+2] == '\x8c')):
			line[i+1]= '\xa4'
			line[i+2]= '\xbe'
		elif line[i]== '\xe0'and line[i+1] =='\xa4'and((line[i+2] == '\xbf')or(line[i+2] == '\x81')or (line[i+2] == '\x82')or (line[i+2] == '\x83')):
			line[i+2]= '\xbe'
			...
			line[i+2]= '\x85'
		elif line[i]== '\xe0'and line[i+1] =='\xa5'and(( line[i+2] == '\x84') or (line[i+2] == '\x86')or(line[i+2] == '\x8a')or (line[i+2] == '\xb2')or (line[i+2] == '\x89')or (line[i+2] == '\xa4')or (line[i+2] == '\x83')):
			line[i+1]= '\xa4'
			line[i+2]= '\xbe'
