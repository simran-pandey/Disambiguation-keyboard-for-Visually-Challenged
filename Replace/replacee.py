...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\x9b') or (line[i+2] == '\x9c')or(line[i+2] == '\x9d') or (line[i+2] == '\x9e')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\x9a'
...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xa0') or (line[i+2] == '\xa1')or(line[i+2] == '\xa2') or (line[i+2] == '\xa3')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\x9f'
...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xa5') or (line[i+2] == '\xa6')or(line[i+2] == '\xa7') or (line[i+2] == '\xa8')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\xa4'
...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xab') or (line[i+2] == '\xac')or(line[i+2] == '\xad') or (line[i+2] == '\xae')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\xaa'
...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xb0') or (line[i+2] == '\xb2')or(line[i+2] == '\xb5') or (line[i+2] == '\xb6')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\xaf'
...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\xb8') or (line[i+2] == '\xb9')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\xaf'
...
for line in characters:
	for i in xrange(len(line)):
		if line[i]== '\xe0'and line[i+1] =='\xa4'and(( line[i+2] == '\x86') or (line[i+2] == '\x87')or(line[i+2] == '\x88')or (line[i+2] == '\x89')or (line[i+2] == '\x8a')or (line[i+2] == '\x8b')or (line[i+2] == '\x8f')or (line[i+2] == '\x90')or (line[i+2] == '\x93') or (line[i+2] == '\x94')):
		    line[i]= '\xe0' 
			line[i+1]= '\xa4'
			line[i+2]= '\x85'
