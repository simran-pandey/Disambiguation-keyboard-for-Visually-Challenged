#!/usr/bin/env python
# encoding: utf-8
f1 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\combination\\input.txt','r')#Updated Corpus file 
f2 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\combination\\result.txt','w')# File containing the unicode representation of words in above file
f3 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\combination\\char_replaced.txt','r')## File containing the unicode representation of words after replacement
f4 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\combination\\counter.txt','w')
f5 = open('C:\\Users\\simran pandey\\Desktop\\IDC\\combination\\output.txt','r')
input = []
freq= []
incharacters= []
characters= []
